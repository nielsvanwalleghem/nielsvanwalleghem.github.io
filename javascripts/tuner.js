...
Tuner.Ui.Debug.prototype.update = function()
{
	...
	if(frequency == -1 || frequency === null || isNaN(frequency)) {
		...
		if(freqint > e && freqint < 288){
            document.getElementById("correct").style.color = "black";
            document.getElementById("low").style.color = "black";
            document.getElementById("high").style.color = "red";

		}
        if(freqint > B && freqint < 221){
            document.getElementById("correct").style.color = "black";
            document.getElementById("low").style.color = "black";
            document.getElementById("high").style.color = "red";

        }
        if(freqint > G && freqint < 171){
            document.getElementById("correct").style.color = "black";
            document.getElementById("low").style.color = "black";
            document.getElementById("high").style.color = "red";

        }
        if(freqint > D && freqint < 128){
            document.getElementById("correct").style.color = "black";
            document.getElementById("low").style.color = "black";
            document.getElementById("high").style.color = "red";

        }
        if(freqint > A && freqint < 96){
            document.getElementById("correct").style.color = "black";
            document.getElementById("low").style.color = "black";
            document.getElementById("high").style.color = "red";
        ...
        if(freqint < e && freqint > 289){
            document.getElementById("correct").style.color = "black";
            document.getElementById("low").style.color = "red";
            document.getElementById("high").style.color = "black";

        }
        if(freqint <B  && freqint > 222){
            document.getElementById("correct").style.color = "black";
            document.getElementById("low").style.color = "red";
            document.getElementById("high").style.color = "black";

        }
        if(freqint < G && freqint > 172){
            document.getElementById("correct").style.color = "black";
            document.getElementById("low").style.color = "red";
            document.getElementById("high").style.color = "black";

        }
        if(freqint < D && freqint > 129){
            document.getElementById("correct").style.color = "black";
            document.getElementById("low").style.color = "red";
            document.getElementById("high").style.color = "black";

        }
        if(freqint < A && freqint > 97){
            document.getElementById("correct").style.color = "black";
            document.getElementById("low").style.color = "red";
            document.getElementById("high").style.color = "black";
